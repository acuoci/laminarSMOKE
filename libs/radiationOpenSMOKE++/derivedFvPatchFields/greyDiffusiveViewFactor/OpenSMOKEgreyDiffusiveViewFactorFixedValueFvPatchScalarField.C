...
OpenSMOKEgreyDiffusiveViewFactorFixedValueFvPatchScalarField
(
    const OpenSMOKEgreyDiffusiveViewFactorFixedValueFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::radiation::OpenSMOKEgreyDiffusiveViewFactorFixedValueFvPatchScalarField::
updateCoeffs()
{
    if (this->updated())
    {
