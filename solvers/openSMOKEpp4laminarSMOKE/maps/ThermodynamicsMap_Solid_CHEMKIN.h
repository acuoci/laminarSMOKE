...
namespace OpenSMOKE
{
	...
	*/
	...
	public:
		...
		*/
		virtual inline void SolidMolecularWeight_From_SolidMoleFractions(double& MW, const OpenSMOKE::OpenSMOKEVectorDouble& x);
		...
		*@param MW the molecular weight of solid mixture in kg/kmol
		*/
		virtual inline void SolidMolecularWeight_From_SolidMassFractions(double& MW, const OpenSMOKE::OpenSMOKEVectorDouble& y);

		/**
		*@brief Calculates the solid mass fractions and the solid molecular weight from the solid mole fractions
		*/
		virtual inline void SolidMassFractions_From_SolidMoleFractions(OpenSMOKE::OpenSMOKEVectorDouble& y, double& MW, const OpenSMOKE::OpenSMOKEVectorDouble& x);
		
		/**
		*@brief Calculates the solid mole fractions and the molecular weight from the solid mass fractions
		*/	
		virtual inline void SolidMoleFractions_From_SolidMassFractions(OpenSMOKE::OpenSMOKEVectorDouble& x, double& MW, const OpenSMOKE::OpenSMOKEVectorDouble& y);
