...
#ifndef OpenSMOKE_DLSODE_H
#define OpenSMOKE_DLSODE_H
...
{
	template <typename T>
	class OpenSMOKE_DLSODE : public OpenSMOKE::OpenSMOKE_OdeSystemSolver<T>
	{
		public:

			OpenSMOKE_DLSODE(T* odeSystem);
	...
	private:
		...
		extern "C" {	void DLSODE(	void FNC(int*,double*,double*,double*),
										int *N,
										double *Y,
										double *T,
										double *TOUT,
	...
	#else
		extern "C" {	void dlsode_(	void FNC(int*,double*,double*,double*),
										int *N,
										double *Y,
										double *T,
										double *TOUT,
...
#include "OpenSMOKE_DLSODE.hpp"

#endif // OpenSMOKE_DLSODE_H
